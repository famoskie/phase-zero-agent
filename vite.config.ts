...
import { vitePluginManusRuntime as viteRuntimePlugin } from "vite-plugin-manus-runtime";
...
const plugins = [react(), tailwindcss(), jsxLocPlugin(), viteRuntimePlugin(), vitePluginDebugCollector()];
